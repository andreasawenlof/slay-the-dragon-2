...
| ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------- | --------------------- |
| **1a. Input action and item with mixed casing (`TAKE sword`, `wAlK door`)**              | Commands should be case-insensitive (converted to lowercase)                            | Tells me that it doesn't understand the command. | ❌            | -                     |
...
| **7. Entering `inventory` when inventory is empty**                                      | Should print **"You have nothing in your inventory."**                                  | Prints out empty array, nothing.                 | ✅/❌         | -                     |
